...
const TESTIMONIALS_DATA = [
  {
    quote:
      "Connecting with my local MLA through this portal solved a land dispute that was pending for years. Thank you Jagan Anna for this initiative.",
    author: "MR. S. REDDY",
  ...
  {
    quote:
      "The NRI cell was incredibly helpful in resolving a documentation issue back home. The process was swift and transparent.",
    author: "DR. V. RAO",
