...
export const countriesData: Country[] = [
  ...
  { name: "Sint Eustatius", code: "599" },
  { name: "Sint Maarten (Netherlands)", code: "1" },
  ...
  { name: "Tonga", code: "676" },
  { name: "Transnistria", code: "373" },
  { name: "Trinidad and Tobago", code: "1" },
  { name: "Tristan da Cunha", code: "290" },
