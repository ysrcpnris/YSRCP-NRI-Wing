...
const UNIVERSAL_PILLAR_DETAILS: Record<number, PillarDetailContent> = {
  1:  {
    ...
    tabs: [
      ...
      { id: 'Arogyasri', title: 'YSR Arogyasri', icon: <ShieldCheck size={18} />, image: "/aro.png", detailStatement: 'Cashless cover up to ₹25 Lakh for serious illnesses.', metrics: [{label: 'Hospitals', value: '2,500+'}], points: ['Cashless high-cost care', 'Post-hospital follow-up'] },
