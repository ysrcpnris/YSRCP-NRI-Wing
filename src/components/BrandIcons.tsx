...
// Website (globe with latitude/longitude lines). Generic icon used in
// the YSR Congress Party social card to point at the party homepage.
export const WebsiteBrand: React.FC<IconProps> = ({ size, className, color = BRAND_COLORS.website }) => (
  <Svg size={size} viewBox="0 0 24 24" className={className}>
    <path
      fill={color}
...
// LinkedIn
export const LinkedInBrand: React.FC<IconProps> = ({ size, className, color = "#0A66C2" }) => (
  <Svg size={size} viewBox="0 0 24 24" className={className}>
    <path
      fill={color}
